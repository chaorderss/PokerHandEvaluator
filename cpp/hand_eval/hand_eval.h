...
DLL_EXPORT int get_hand_rank_holdem(const int* hand_2d, const int* board_2d);
...
DLL_EXPORT void get_hand_rank_all_hands_on_given_boards_holdem(
    ...
    const int* boards_2d,    // 输入: N * 5 * 2
    int n_boards,
    const int* lut_hole_cards, // 1326 * 2 * 2
    const int* lut_1dcard_2d   // 52 * 2
);
